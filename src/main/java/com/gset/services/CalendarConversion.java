 ...
 * @since 2016-01-01
 */
public class CalendarConversion implements Serializable {
    ...
    public String getIranianDateFix10Char() {
        String strMonth = String.valueOf(irMonth);
        String strDay = String.valueOf(irDay);
        if (irMonth < 10) {
            strMonth = "0" + irMonth;
        }
        if (irDay < 10) {
        ...
        return (irYear + "-" + strMonth + "-" + strDay);
    }

    public String getGregorianDate() {
        return (gYear + "-" + checkTime(gMonth) + "-" + checkTime(gDay));
    }
